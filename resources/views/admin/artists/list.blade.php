            ...
            <div class="nav-wrapper teal">
                <form method="get" action="{{url('admin/artists/' . $sort)}}">
                    <div class="input-field">
                        <input value="{{isset($search)? $search: ''}}" placeholder="جستجوی نام و نام خانوادگی" style="text-align: center; line-height: 60px; height: 60px;" name="search" type="search" required>
